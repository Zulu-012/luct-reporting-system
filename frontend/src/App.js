...
function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case "studentPortal":
        return user ? <StudentPortal user={user} onLogout={handleLogout} /> : <Home onNavigate={handleNavigate} />;
      case "dashboard":
        return user ? <Dashboard user={user} onLogout={handleLogout} onNavigate={setCurrentPage} /> : <Home onNavigate={handleNavigate} />;
